...
public class RedisServiceOrchestrator implements Orchestrator {
    ...
    public void call(Message message) {
        ...
        logger.debug("Send redis message on topic {} with message receiver -> {}", redisMessage.getReceiverTopic(), redisMessage.getReceiverTopic());
    ...
    public void receive(Consumer<Message> callback) {
        ...
        redisMessageListenerContainer.addMessageListener(messageListener, new ChannelTopic("orange_connector_topic"));
